...
import com.example.dy.controller.demo;
...
public class OcrSample {
    public static void processOcrDocument()
        ...
        InputStream page = OcrSample.class.getResourceAsStream(filePath);
        if (page != null) {
        ...
        InputStream credentialsStream = OcrSample.class.getResourceAsStream("/comp3820-digital-health-be5b27c74b2d.json");

        if (credentialsStream != null) {
            // 设置 GOOGLE_APPLICATION_CREDENTIALS 环境变量
            System.out.println("ooooooo");
            URL resourceUrl = OcrSample.class.getClassLoader().getResource("comp3820-digital-health-be5b27c74b2d.json");
